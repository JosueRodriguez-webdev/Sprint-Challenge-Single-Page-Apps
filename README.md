...
> Answer: Part of the benefit of using client-side routing is that it's much more fluent and responsive in terms of navigating thru the site because it doesn't need to send network request when switching pages on a website.
